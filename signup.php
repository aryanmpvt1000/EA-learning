...
function validate() {
 ...
 /* if( document.myForm.Checkbox.value !== Checkbox.un ) {
     alert( "Please check our Privacy Policy" );
...
<body>
   ...
   <header>
    ...
    <img src="http://localhost/E-learning%20project/images/signup.jpg" width="100%" height="500px" id="photo">
    <br>
    <br>
...
if($showError){
    ...
    <form id="form" action = "/E-learning project/signup.php" method="post" name = "myForm" onsubmit = "return(validate());">
        ...
        <label id="checkbox_lable">I'm in for emails with exciting discounts and personalized recommendations.</label><br><br>
